...
#include "sleep_manager_base.hpp"
  ...
  public:
    Peripheral::Status init() override { return Peripheral::Status::OK; }
    bool is_ready() const override { return true; }
    etl::string<SLEEP_MANAGER_NAME_SIZE> get_name() const override { return "Dummy"; }
...
class SleepManager : public Peripheral {
 public:
  ...
  Peripheral::Status init() override { return impl.init(); }
  bool is_ready() const override { return impl.is_ready(); }
  etl::string<SLEEP_MANAGER_NAME_SIZE> get_name() const override { return impl.get_name(); }

  void enter_sleep(SleepMode mode) { impl.enter_sleep(mode); }
  void set_sleep_duration(int ms) { impl.set_sleep_duration(ms); }
  void timed_sleep() { impl.timed_sleep(); }

  WakeCause get_wakeup_cause() const { return impl.get_wakeup_cause(); }
